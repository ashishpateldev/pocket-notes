...
function App() {
      return (
            <>
                  <div class='flex'>
                        <div class='h-[100vh] w-[24em] bg-white m-0 p-0'>
                              <h1 class='text-4xl font-bold ml-20 mt-8 mb-8'>Pocket Notes</h1>
                              ...
                              <div class='flex'>
                                    <div class='h-16 w-16 bg-[rgba(22,0,139,1)] rounded-full text-white flex items-center justify-center ml-[8em] font-bold mb-5 text-4xl'>+</div>
                              </div>
